...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        mydata=pd.read_csv('data/ETT/ETTh1.csv',header=0)
        len_data=len(mydata)
        len_train=int(len_data*train_set*0.75)
        len_val=int(len_data*train_set)
        del mydata
        border1s = [0, len_train - self.seq_len,len_val - self.seq_len]  # 初始[0,8544,11472]
        border2s = [len_train, len_val,len_data]  # 初始[8640,11520,14400]
    ...
    def inverse_transform(self, data):
        # print('\nDataset_ETT_hour ---inverse_transform \n')
...
class Dataset_Pred(Dataset):
    ...
    def inverse_transform(self, data):
        print('\nDataset_Pred_hour ---inverse_transform \n')
        return self.scaler.inverse_transform(data)
